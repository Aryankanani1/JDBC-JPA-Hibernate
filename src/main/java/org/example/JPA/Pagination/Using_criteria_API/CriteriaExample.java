package org.example.JPA.Pagination.Using_criteria_API;
...
/**
 * Same pagination as the JPQL example, but built type-safely with the Criteria API.
 */
public class CriteriaExample {
    public static void main(String[] args) {
        ...
        // Build: SELECT u FROM AnnotatedUser u ORDER BY u.id
        ...
        int pageNumber = 1;
        int pageSize = 10;
        List<User> page = em.createQuery(cq)
